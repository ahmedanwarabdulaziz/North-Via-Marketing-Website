                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white relative z-10">
                      <h2 className="text-4xl lg:text-5xl font-black leading-tight mb-4">
                        <span className="block text-white">Why Most Designs</span>
                        <span className="block text-[#f27921]">Don't Deliver Results</span>
                      </h2>
                  ...
                  <div className="pt-8 mt-4">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-700 leading-relaxed">Social and web design support</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="pt-8 mt-4">
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-700 leading-relaxed">Full creative direction, branding, and ongoing visual consulting</p>
                      </div>
                    </div>
                  </div>
                </div>
