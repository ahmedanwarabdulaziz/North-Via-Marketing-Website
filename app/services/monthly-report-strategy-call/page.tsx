            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative mb-16">
                <div className="relative h-64 rounded-3xl overflow-hidden shadow-2xl">
                  <Image
                    src="/x002.png"
                    alt="Why Reports Alone Aren't Enough Banner"
                    fill
                    className="object-cover"
                  />
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="mt-8 text-lg text-gray-700">
                <p className="mb-2"><strong>Essential Growth</strong> – simplified report + monthly call</p>
                <p className="mb-2"><strong>Performance Partner</strong> – full multi-channel report + strategic roadmap</p>
                <p><strong>Strategic Partner</strong> – detailed business performance review + quarterly growth planning</p>
              </div>
            </div>
          </div>
        </section>
